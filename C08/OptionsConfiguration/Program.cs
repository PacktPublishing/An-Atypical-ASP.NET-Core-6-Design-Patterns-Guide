...
builder.Services.Configure<ConfigureMeOptions>(builder.Configuration.GetSection("configureMe"));
builder.Services.AddSingleton<IConfigureOptions<ConfigureMeOptions>, Configure1ConfigureMeOptions>();
builder.Services.AddSingleton<IConfigureOptions<ConfigureMeOptions>, Configure2ConfigureMeOptions>();
...
app.MapGet("/configure-me", (IOptionsMonitor<ConfigureMeOptions> options) => options.CurrentValue);
app.Run();
